...
OPCODES :: enum {
    ...
    GE, // check if a register is greater than another                                  reg1 > reg2 -> stack[sp++]
    LE, // check if a register is less than another                                     reg1 != reg2 -> stack[sp++]
    GEQ, // check if a register is greater than or euqal to another                     reg1 >= reg2 -> stack[sp++]
    LEQ, // check if a register is less than or equal to another                        reg1 <= reg2 -> stack[sp++]
